...
file: cubos_04_textura-lighting.py
----------------------------
Dibuja 4 cubos texturizados rotando con distintos efectos de iluminación.
...
def listaCuboFlatTex(texture):
    ...
    tdraw4Vertexfvn(a,b,c,d,n1,t1,t2,t3,t4)
    tdraw4Vertexfvn(b,f,g,c,n2,t1,t2,t3,t4)
    tdraw4Vertexfvn(f,e,h,g,n3,t1,t2,t3,t4)
    tdraw4Vertexfvn(e,a,d,h,n4,t1,t2,t3,t4)
    tdraw4Vertexfvn(d,c,g,h,n5,t1,t2,t3,t4)
    tdraw4Vertexfvn(a,e,f,b,n6,t1,t2,t3,t4)
...
def listaCuboSmoothTex(texture):
    ...
    tdraw4Vertexfvn4(a,b,c,d,na,nb,nc,nd,t1,t2,t3,t4)
    tdraw4Vertexfvn4(b,f,g,c,nb,nf,ng,nc,t1,t2,t3,t4)
    tdraw4Vertexfvn4(f,e,h,g,nf,ne,nh,ng,t1,t2,t3,t4)
    tdraw4Vertexfvn4(e,a,d,h,ne,na,nd,nh,t1,t2,t3,t4)
    tdraw4Vertexfvn4(d,c,g,h,nd,nc,ng,nh,t1,t2,t3,t4)
    tdraw4Vertexfvn4(a,e,f,b,na,ne,nf,nb,t1,t2,t3,t4)
...
# inicializando ...
init_pygame((W,H),"cubos_04_textura-lighting")
init_opengl((W,H))
...
cubo = listaCuboFlatTex(tex)
cubo_s = listaCuboSmoothTex(tex)

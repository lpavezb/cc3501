...
class Rio:
    def __init__(self, dh):
        ...
        # RUT = 19401577-1
        self._RRR = 577
        self._mar = 1200 + 400 * self._RRR
        self._planta = self._mar + 120
        self._inicio_cordillera = self._mar + 400
        self._cima1 = self._mar + 1200
        self.valle = self._mar + 1500
        self._cima2 = self._mar + 2000
...
def _test_medir_presion():
    r = Rio(0.25)  # rio de 3.5 metros de ancho, 7 de largo y una grilla de 0.25 metros de lado

...
file: cubos_01_colores.py
----------------------
Dibuja un cubo amarillo y un cubo de colores en la escena, ambos rotan en torno a distintos ejes.
...
def listaCubo():
    ...
    draw4Vertexfv(b,f,g,c)
    draw4Vertexfv(f,e,h,g)
    draw4Vertexfv(e,a,d,h)
    draw4Vertexfv(d,c,g,h)
    draw4Vertexfv(a,e,f,b)
...
# inicializando ...
init_pygame((W,H),"cubos_01_colores")
init_opengl((W,H))
...
while run:
    ...
    drawList(cubo,pos = [0,0,0],o = o,rot = [0,0,1],sz = [1000,1000,100],rgb = [1.0,1.0,0.0,0.5])
    drawList(cubo_c,pos = [1000,0,0],o = o,rot = [-1,0,0],sz = [600,600,600],rgb = None)
